...
void createInstallation(ParseClientInternal *parseClient) {
    ...
    if (strlen(parseClient->installationObjectId) == 0) {
        ...
        parseSendRequestInternal((ParseClient)parseClient, "POST", "/1/installations", content, createInstallationCallback, FALSE, jsonObject);
    }
}
...
void getInstallation(ParseClientInternal *parseClient) {
    ...
    if (strlen(parseClient->installationObjectId) > 0) {
        ...
        parseSendRequestInternal((ParseClient)parseClient, "GET", content, NULL, getInstallationCallback, FALSE, jsonObject);
        ...
        parseSendRequestInternal((ParseClient)parseClient, "GET", "/1/installations", content, getInstallationByIdCallback, FALSE, jsonObject);
    }
