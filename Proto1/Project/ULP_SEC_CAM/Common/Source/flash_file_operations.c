...
//	param[in]	uiMaxFileSize - maximum file size - this size is allocated on
//								the flash for this file
//
...
//
//	return error codes or number of bytes written
//******************************************************************************
